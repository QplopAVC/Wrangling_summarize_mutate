...
movies %>%
  ...
  summarize(bad_movies_count = n())
```

To paraphrase my code I took the percentages of people who rated movies 4 and below which is r1 - r4. r5 - r10 are high ratings so they are excluded. I filtered it so that the votes as anything lower than 5 and above 50%. This gave me 4753 movies. 
